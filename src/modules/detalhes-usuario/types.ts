...
export const GET_HISTORICO_ALGORITMOS_REQUESTED =
  "@detalhesUsuario/GET_HISTORICO_ALGORITMOS_REQUESTED";
export const GET_HISTORICO_ALGORITMOS_SUCCEEDED =
  "@detalhesUsuario/GET_HISTORICO_ALGORITMOS_SUCCEEDED";
export const GET_HISTORICO_ALGORITMOS_FAILED =
  "@detalhesUsuario/GET_HISTORICO_ALGORITMOS_FAILED";
export const GET_HISTORICO_ALGORITMOS_CLEAN_ERRORS =
  "@detalhesUsuario/GET_HISTORICO_ALGORITMOS_CLEAN_ERRORS";
...
export const UPDATE_DADOS_CLEAN_ERRORS =
  "@detalhesUsuario/UPDATE_DADOS_CLEAN_ERRORS";
...
export type DetalhesUsuarioActionTypes =
  | GetHistoricoAlgoritmosRequestAction
  | GetHistoricoAlgoritmosSucceededAction
  | GetHistoricoAlgoritmosFailedAction
  | GetHistoricoAlgoritmosCleanErrorsAction
  | UpdateDadosRequestAction
  | UpdateDadosSucceededAction
  | UpdateDadosFailedAction
  | UpdateDadosCleanErrorsAction;
